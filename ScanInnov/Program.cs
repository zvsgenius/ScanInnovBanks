...
namespace ScanInnov
{
    class Program
    {
        static string baseLink = "http://tl.innov.ru/banks/";
        ...
        {            
            ...
            if (firstStart)
            {
                ...
                links.Add(protocol + domainName + "/banks/exchange-rates/");
                links.Add(protocol + domainName + "/banks/value-metals/");
                links.Add(protocol + domainName + "/banks/exchange-rates-ext/");
                links.Add(protocol + domainName + "/banks/online/");
                links.Add(protocol + domainName + "/banks/news/");
                links.Add(protocol + domainName + "/banks/foreclosure-sale/");
                links.Add(protocol + domainName + "/banks/corporate-banking/");
                links.Add(protocol + domainName + "/banks/personal-banking/");
        ...
        private static string CreateFile(string link, string path)
        {
            ...
            if (link[link.Length - 1] == '/')
                ...
                newPath = path + "\\" + link.Substring(link.LastIndexOf('/') + 1);
